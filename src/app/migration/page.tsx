      ...
      >
        ...
        <div className="p-4 lg:p-8 max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Migrate to HPP</h1>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg shadow-sm mt-8">
              <div className="p-6">
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-3">Complete Your Migration</h2>
                  <p className="text-gray-600">
                ...
                <div className="bg-white rounded-lg p-6">
                  <div className="text-center">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4">HPP (ETH) → HPP Native</h3>
