        ...
        <div className="p-4 lg:p-8 max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-4xl">
              The HPP Ecosystem is an AI-native infrastructure designed for the full data lifecycle, uniting intelligent
              agents, verifiable off-chain computation, and decentralized applications.
            </p>
          </div>
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-gray-600">Join our growing ecosystem of partners</p>
          </div>
